function [AccEXTRA_x,  opt_residual, idx, AccEXTRA_hyper,AccEXTRA_stopIter] = AccEXTRA(W, x_init, ToI, c_K)
global I d mu_empri L_empri Q lambda eps
...
AccEXTRA_x = x0;
AccEXTRA_stopIter = idx{out_iter + 1}-1;
end
